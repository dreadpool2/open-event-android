...
<<<<<<< HEAD:android/app/src/main/java/org/fossasia/openevent/activities/SessionDetailActivity.java
                String speakers = "";
...
=======
                ...
                String endTime = DateConverter.formatDateWithDefault(DateConverter.FORMAT_DATE_COMPLETE, session.getEndsAt());
                String shareText = String.format(getResources().getString(R.string.session_track_details) + " %s \n" +
>>>>>>> 0dad732d809874d8a42b868deaaa50a2319791b4:android/app/src/main/java/org/fossasia/openevent/core/track/session/SessionDetailActivity.java
